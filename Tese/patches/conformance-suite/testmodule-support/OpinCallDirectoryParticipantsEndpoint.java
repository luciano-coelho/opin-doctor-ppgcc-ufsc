...
public class OpinCallDirectoryParticipantsEndpoint extends AbstractCondition {

	private static final String DEFAULT_PARTICIPANTS_URI = "https://data.sandbox.directory.opinbrasil.com.br/participants";
	...
	public Environment evaluate(Environment env) {
		...
		String PARTICIPANTS_URI = apiBase != null
				? (apiBase.endsWith("/") ? apiBase + "participants" : apiBase + "/participants")
				: DEFAULT_PARTICIPANTS_URI;
