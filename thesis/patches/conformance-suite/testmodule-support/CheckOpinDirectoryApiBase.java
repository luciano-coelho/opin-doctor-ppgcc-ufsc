...
public class CheckOpinDirectoryApiBase extends AbstractCondition {
    private final String BRAZIL_SANDBOX_DIRECTORY_API_BASE = "https://matls-api.sandbox.directory.opinbrasil.com.br/";
    private final String BRAZIL_DIRECTORY_API_BASE = "https://matls-api.directory.opinbrasil.com.br/";
    private final String LOCAL_MOCK_DIRECTORY_API_BASE = "https://directory/";
    private final Set<String> ACCEPTABLE_API_URLS = Set.of(BRAZIL_SANDBOX_DIRECTORY_API_BASE, BRAZIL_DIRECTORY_API_BASE, LOCAL_MOCK_DIRECTORY_API_BASE);
