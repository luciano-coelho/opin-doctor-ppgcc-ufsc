# Median Report (pqc, 320ms, 10 runs)

Generated at: 2026-08-29T00:31:28.518309+00:00
...
2 run(s) needed a retry (see thesis/results/v5/DECISIONS.md, Decision 5):

- run 3, attempt 1: HTTPError: 502 Server Error: Bad Gateway for url: https://auth.local/request
- run 4, attempt 1: HTTPError: 400 Client Error: Bad Request for url: https://auth.local/token
